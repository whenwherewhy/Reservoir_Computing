...
class LSM:
    def __init__(self, input_size, width, height, output_size, 
                 lamda=5, primary_to_auxiliary_ratio=0.6, input_feature_selection_sparsity=0.6, neuron_type_ratio=0.8,
                 stp_alpha = 0.01, stp_beta = 0.3):
    ...
    def get_activation(self, ST_input, simulation_time=10000):
        ...
        S_t = np.ones((len(self.liquid_layer_neurons),)) #STP vector
